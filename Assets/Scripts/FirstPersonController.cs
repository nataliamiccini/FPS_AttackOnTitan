...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private bool ShouldCrouch =>
			Input.GetKeyDown(crouchKey) && !DuringCrouchANimation;
		...
		[Header("Control")] [SerializeField] private KeyCode crouchKey = KeyCode.LeftControl;
		[SerializeField] private KeyCode jumpKey = KeyCode.J;
			
		[Header("Functionl Options")] 
		[SerializeField] private bool canCrouch = true;

		[Header("Crouch Parameters")] [SerializeField]
		private float crouchHeight = 0.5f;
		[SerializeField] private float StandingHeight = 2f;
		//[SerializeField] private float stand = 2f;
		[SerializeField] private float timeToCrouch = 0.25f;
		[SerializeField] private Vector3 CouchCenter = new Vector3(0,0.5f,0);
		...
		private IEnumerator CrouchStand()
		{
			...
			Vector3 targetCenter = isCrouch ? standingCenter : CouchCenter;
